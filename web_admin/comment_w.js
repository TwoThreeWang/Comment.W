...
/* 评论逻辑 */
document.getElementById('comment_w').innerHTML = `<div class="com_reply_body"id="com_reply_body"><div class="com_reply_msg"id="com_reply_msg"style="display:none">Reply to：<b id="com_reply_name"></b><span onclick="remove_reply()">取消回复</span></div><textarea rows="5"name="text"id="comment_text"class="text"tabindex="5"required=""></textarea><div class="com_yan"id="com_yan"style="display:none"><span onclick="add_yan(' w(ﾟДﾟ)w ')">w(ﾟДﾟ)w</span><span onclick="add_yan(' (╥_╥) ')">(╥_╥)</span><span onclick="add_yan(' ︿(￣︶￣)︿ ')">︿(￣︶￣)︿</span><span onclick="add_yan(' o(￣ヘ￣o＃) ')">o(￣ヘ￣o＃)</span><span onclick="add_yan(' (＠_＠;) ')">(＠_＠;)</span><span onclick="add_yan(' X﹏X ')">X﹏X</span><span onclick="add_yan(' :-) ')">:-)</span><span onclick="add_yan(' (๑•̀ㅂ•́)و✧ ')">(๑•̀ㅂ•́)و✧</span><span onclick="add_yan(' （*＾-＾*） ')">（*＾-＾*）</span><span onclick="add_yan(' (￣△￣；) ')">(￣△￣；)</span><span onclick="add_yan(' (⊙ˍ⊙) ')">(⊙ˍ⊙)</span><span onclick="add_yan(' ╮（╯＿╰）╭ ')">╮（╯＿╰）╭</span><span onclick="add_yan(' (⊙﹏⊙) ')">(⊙﹏⊙)</span><span onclick="add_yan(' （╬￣皿￣） ')">（╬￣皿￣）</span><span onclick="add_yan(' Thanks♪(･ω･)ﾉ ')">Thanks♪(･ω･)ﾉ</span></div><div class="com_reply_button"><div class="info_button"><span class="com_button"onclick="chenge_yan()">表情</span><span class="com_button"onclick="add_img()">图片</span></div><div class="comm_button_body"><span class="com_user"id="com_user"style="display:none"><span id="com_username"></span><a href=""onclick="com_login_out()">[退出]</a></span><span class="com_login"id="com_login"><input placeholder="用户名"type="text"class="input"id="comm_username"><input placeholder="邮箱"type="text"class="input"id="comm_email"></span><span class="com_button"onclick="do_send()"id="send_button">发送</span></div></div></div><div class="coms_body"id="commentArea"><div id="com_more">初始化...</div></div>`;
